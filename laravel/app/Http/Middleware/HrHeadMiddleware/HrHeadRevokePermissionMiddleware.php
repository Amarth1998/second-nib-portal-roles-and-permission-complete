...
namespace App\Http\Middleware\HrHeadMiddleware;
...
class HrHeadRevokePermissionMiddleware
{
    /**
    ...
    //     // Restrict revoking permissions from users with "SuperAdmin" or "Head Admin" or "HR Head" roles
