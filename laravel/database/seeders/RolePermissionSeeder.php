...
class RolePermissionSeeder extends Seeder
{
    public function run()
    {
        ...
        $hr_Head_Role->syncPermissions(Permission::where('guard_name', $guardName)->whereIn('name', $hrHeadPermissions)->get());
        $sub_Hr_Head_Role->syncPermissions(Permission::where('guard_name', $guardName)->whereIn('name', $hrHeadPermissions)->get());
        $hr_Role->syncPermissions(Permission::where('guard_name', $guardName)->whereIn('name', $hrHeadPermissions)->get());
    }
}
